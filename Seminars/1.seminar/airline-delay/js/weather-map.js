class WeatherMap {
  constructor() {
    this.mapLayerName = 'weather-radar-layer'
    this.openDateModalButton = document.getElementById('dataPickerButton')
    this.submiDateButton = document.getElementById('unixTsSubmit')
    this.dateTimePicker = document.getElementById('datePickerInput')
    this.weatherCheckbox = document.querySelector('input[id=weatherCheckbox]')
  ...
  generateWeatherRadarTimestamp(date) {
    return (
      date.getFullYear() +
